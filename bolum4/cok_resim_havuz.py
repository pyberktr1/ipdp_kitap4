# Bu ornek coklu proses havuzu icracisi araciligi ile
# resimleri paralel bicimde isleyen bir resim isleme 
# prosesini gosterir
...
if __name__ == '__main__':
    ...
    # proses havuzu ile prosesler isletiliyor
    with pp_icraci() as icraci:
        icraci.map(resim_isle, resimler)
