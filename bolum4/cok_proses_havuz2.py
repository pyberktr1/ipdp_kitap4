...
# isci proseslerin sayisina bir sinirlama getirildigi
# icin sonuclanma suresi uzayacaktir
...
if __name__ == '__main__':
    ...
    # mevcuttaki islemci sayisi sorgulaniyor
    cpu_sayisi = os.cpu_count()
    print("Mevcut islemci sayisi = ", cpu_sayisi)
    ...
    # burada isci proseslerin sayisini sinirlandirabiliriz
    # islemci sayisini bir tamsayiya bolerek hazirdaki
    # islemcilerden sadece bir bolumunu kullaniyoruz
    with pp_icraci(max_workers=cpu_sayisi//20) as icraci:
