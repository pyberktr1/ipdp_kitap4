# bu ornek basit gorev iptalini gosterir
...
async def ana():
    ...
    # iptal edebiliriz
    if not gorev3.done():# gorev3 tamamlandi mi?
        print("Zamanlayici kapatiliyor...")
        gorev3.cancel()
    ...
    try:
        ...
        print("Zamanlayici gorevi basari ile iptal edildi!")
