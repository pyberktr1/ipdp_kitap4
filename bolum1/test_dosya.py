# iplere dayali dosya islemleri ornekleri icin
# test dosyalari olusturan program
metin = [ 
    """KÜTÜK
Ömer SEYFETTİN
...
for i in range (1,11):
    with open(f'./dosya/test{i}.txt', 'wb') as f:
        f.write(metin[i-1].encode('utf-8'))
        
print(f'{i} adet dosya basari ile olusturuldu')
