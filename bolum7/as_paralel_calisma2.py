...
# esnasinda gorevleri beklemezsek ne olacagini gosterir
...
async def ana():
    ...
    # ana program bolumunde gerceklesitirilir. Ayni anda birden
    ...
    # birinci gorev beklenmeden cagriliyor
    kup =  gorev1
    print(f"kup: {kup}")
    
    # ikinci gorev beklenmeden cagriliyor
    kare =  gorev2
    print(f"kare: {kare}")
    
    # gorevlerin tamamlanmasini beklemedigimiz icin acilan olay dongusu
    # acildigi gibi kapatilir. Sonuc olarak sonuclari alamadan program
    # biter. Bu durum ayrica bir hata mesajiyla bildirilmektedir.
