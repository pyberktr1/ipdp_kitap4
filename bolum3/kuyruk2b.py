...
def tuket(dur, duraklat:Event, kuyruk2):
    ...
    while not (dur.is_set()):
        ...
        while duraklat.is_set():
            durak = True
            print("\rCalma duraklatildi..................................", end="")
            sleep(ornekleme_peryodu)
            if dur.is_set(): # durdurma sinyali var
                # duraklatmayi iptal et
                break
        if durak:# bir duraklatma olmus
            durak = False
            print("\nCalma devam ediyor..................................")
    ...
    print(f"\nCalma sona erdi... Kacirilan ornek sayisi {n} oldu.")
...
def ana():
    ...
    durak_sure = 5
    duraklat.set()
    sleep(durak_sure)# saniye duraklat
    ...
    print(f"Toplam isletim suresi = {veri[1] - veri[0]:3.5f} "
          f"saniye ve son ornek : {veri[2]}")
    print(f"Ortalama ornekleme suresi = "
          f"{(veri[1] - veri[0] - durak_sure) / veri[2]:3.5f} saniye oldu")
