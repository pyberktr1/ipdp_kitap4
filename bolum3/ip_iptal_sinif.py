...
# iptal edilebilecegini sinif tanimi üzerinden gosterir
...
class isci(Thread):
    def __init__(self, iptal, sonuc, *args, **kwargs):
    ...
    def run(self):
        ...
        for i in range(10):
            ...
            if self.iptal.is_set(): # iptal sinyali geldi mi?
