...
# ortak hafiza alani
mesaj = [] # gunce islemleri icin ortak tampon alani
sayac = 0  # gosterilen mesaj sayaci
...
def islem(ipid):
    ...
    for i in range(100):
        ...
        with kilit:
            ...
            # durum mesaji uretiliyor ve mesaj tamponuna atiliyor
...
def gunce(sure):
    ...
    while True:
        # gunluk fonksiyonunun guncellenme sikligi
        sleep(sure)
...
ip = Thread(target=gunce, args=(sure,), daemon=True)
ip.start()
