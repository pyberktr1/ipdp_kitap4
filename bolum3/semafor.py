...
# semafor kullanimi sayesinde indirme sayisi sinirlandiriliyor
...
# indirme limiti
max_indirme_limiti = 2
# semafor tanimlaniyor
semafor = threading.Semaphore(max_indirme_limiti)
...
def im_indir(url):
    ...
    # semafor ile indirme limiti getiriliyor
    with semafor:
